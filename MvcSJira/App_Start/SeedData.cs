...
namespace MvcSJira.App_Start
{
    public class SeedData : IRunAtStartup
    {
         ...
         public void Execute()
        {
            ...
            CreateProjectCategory(_context);
            CreateProjectType(_context);
            CreateUser(_context);
            CreateStatus(_context);
            CreateWorkType(_context);
            CreateIssueType(_context);
            CreateIssuePriority(_context);
            CreateIssueResolution(_context);
            CreateProject(_context);
            CreateSprint(_context);
            CreateIssue(_context);
            CreateWork(_context);
            CreateMenuItemType(_context);
            CreateMenuItems_Home_Main(_context);
            CreateMenuItems_Home_Secondary(_context);
            CreateMenuItems_My_Open_Issues_SideBar(_context);
            CreateMenuItems_My_Open_Issues_ToolBar(_context);
            CreateGadgetType(_context);
            CreateGadget(_context);
            CreateSharedWith(_context);
            CreateBoardType(_context);
            CreateDashboardType(_context);
            CreateDashboard(_context);
            CreateDashboardMenuItems(_context);
            CreateDashboardGadget(_context);
            CreateDashboardUser(_context);
        }
        ...
        //    var BarMenuManager1 = context.BarMenuManagers.Where(c => c.Title == "My Open Issues SideBar").FirstOrDefault();
        ...
        //    var BarMenuManager1 = context.BarMenuManagers.Where(c => c.Title == "My Open Issues ToolBar").FirstOrDefault();
        //    BarMenuItem entity = new BarMenuItem();
        ...
        //{
        //    var Child = context.MenuItems.Where(c => c.Title == "My Open Issues").FirstOrDefault();
