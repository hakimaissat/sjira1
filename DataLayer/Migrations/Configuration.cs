namespace DataLayer.Migrations
{
    ...
    public class Configuration : DbMigrationsConfiguration<DataLayer.Context.SJiraContext>
    {
        ...
        protected override void Seed(DataLayer.Context.SJiraContext context)
        {
...
//        }
        ...
        private void CreateWork(SJiraContext context)
        {
            ...
            var user1 = context.Users.Local.Where(c => c.UserName == "XT19141").FirstOrDefault();
            var user2 = context.Users.Local.Where(c => c.UserName == "xt17640").FirstOrDefault();
